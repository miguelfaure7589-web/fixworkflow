    ...
    <div className="bg-slate-800/50 border border-slate-700 rounded-xl p-6">
      <div className="flex items-center gap-3 mb-4">
        ...
        <div>
          ...
          <p className="text-sm text-slate-400">{tool.pricing}</p>
        </div>
      </div>
      ...
      <div className="mb-4">
        <div className="text-sm text-slate-400 mb-1">Free Tier:</div>
      ...
      <div className="text-sm text-slate-400 mb-4">
        Rating: <span className="text-yellow-400">{tool.rating}/5</span>
      </div>
      <a
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950">
      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        <h1 className="text-3xl font-bold text-white mb-4">{comparison.title}</h1>
        <p className="text-slate-400 mb-10">{comparison.description}</p>
        ...
        <div className="bg-blue-600/10 border border-blue-500/20 rounded-xl p-6 mb-10">
          <h2 className="text-lg font-semibold text-white mb-2">Our Verdict</h2>
          <p className="text-slate-300">{comparison.verdict}</p>
        </div>

        {/* CTA */}
        <div className="text-center bg-slate-800/40 border border-slate-700 rounded-xl p-8">
