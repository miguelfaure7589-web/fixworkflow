...
// ── Error Boundary to prevent cascade ──
...
> {
  ...
  componentDidCatch(error: Error) {
    console.error("[CommandCenter] Render error:", error);
  }
          ...
          <div>
            <div style={{ textAlign: "center", padding: "24px 16px 16px" }}>
              ...
              <Link href="/settings" style={{
                ...
                background: "linear-gradient(135deg, #4361ee, #6366f1)",
                color: "#fff", fontSize: 13, fontWeight: 700, textDecoration: "none", marginBottom: 16,
              }}>
                Connect Integration
              </Link>
            </div>
